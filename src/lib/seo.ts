...
> = {
  ...
  "body-in-numbers": {
    title: "Тело в цифрах — UX/UI кейс системы учета здоровья",
    description:
    ...
    ogTitle: "Тело в цифрах — UX/UI кейс HealthTech-системы",
    ogDescription:
      "Рабочий MVP личного учета здоровья с ручным вводом, Apple Health, Firebase и подготовкой структурированных данных к AI-анализу.",
  },
};
